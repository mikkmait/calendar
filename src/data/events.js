const eventList = [
  ...
  { timeHour: '12', timeMinute: '00', date: 4, month: 4, year: 2023, allDay: true, name: 'In Tartu', type: 'personal', location: 'Tartu' },
  { timeHour: '14', timeMinute: '00', date: 4, month: 4, year: 2023, allDay: false, name: 'Meeting Ellinor', type: 'personal', location: 'Tartu' },
  { timeHour: '19', timeMinute: '00', date: 4, month: 4, year: 2023, allDay: false, name: 'Kriis.ID performance', type: 'WORK', location: 'Tartu' },
  { timeHour: '21', timeMinute: '00', date: 4, month: 4, year: 2023, allDay: false, name: 'To Tallinn', type: 'personal', location: 'Bussijaam' },
  { timeHour: '07', timeMinute: '00', date: 5, month: 4, year: 2023, allDay: false, name: 'To Tallinn', type: 'personal', location: 'Raudteejaam' },
  { timeHour: '14', timeMinute: '00', date: 5, month: 4, year: 2023, allDay: false, name: 'To Tartu', type: 'personal', location: 'Vene kultuurikeskus' },
  { timeHour: '23', timeMinute: '59', date: 5, month: 4, year: 2023, allDay: false, name: 'To Tallinn', type: 'personal', location: 'Tartu Elektriteater' },
  { timeHour: '18', timeMinute: '00', date: 5, month: 4, year: 2023, allDay: false, name: 'Elektriteater birthday', type: 'EVENT', location: 'Tartu' },
  { timeHour: '09', timeMinute: '00', date: 5, month: 4, year: 2023, allDay: false, name: 'False/Falling rehearsal', type: 'WORK', location: 'Tallinn' },
  { timeHour: '11', timeMinute: '00', date: 2, month: 4, year: 2023, allDay: false, name: 'Spooky action Festival meeting', type: 'WORK', location: 'Studio' },
  ...
  { timeHour: '14', timeMinute: '00', date: 3, month: 4, year: 2023, allDay: false, name: 'Trenn', type: 'sailing', location: 'Pirita' },
  { timeHour: '16', timeMinute: '00', date: 3, month: 4, year: 2023, allDay: false, name: 'Kolmapäevak', type: 'sailing', location: 'Pirita' },
  { timeHour: '21', timeMinute: '00', date: 3, month: 4, year: 2023, allDay: false, name: 'To Tartu', type: 'personal', location: 'Bussijaam' },
  ...
  { timeHour: '16', timeMinute: '30', date: 8, month: 4, year: 2023, allDay: false, name: 'Kolmapäevak', type: 'sailing', location: 'Pirita' },
  { timeHour: '16', timeMinute: '30', date: 8, month: 4, year: 2023, allDay: false, name: 'Kolmapäevak', type: 'sailing', location: 'Pirita' },
  { timeHour: '16', timeMinute: '30', date: 8, month: 4, year: 2023, allDay: false, name: 'Kolmapäevak', type: 'sailing', location: 'Pirita' },
  { timeHour: '16', timeMinute: '30', date: 8, month: 4, year: 2023, allDay: false, name: 'Kolmapäevak', type: 'sailing', location: 'Pirita' },
  { timeHour: '16', timeMinute: '30', date: 8, month: 4, year: 2023, allDay: false, name: 'Kolmapäevak', type: 'sailing', location: 'Pirita' },
  ...
  { timeHour: '14', timeMinute: '00', date: 9, month: 4, year: 2023, allDay: false, name: 'SDA Individual workshop', type: 'coursework', location: 'Online' },
  { timeHour: '14', timeMinute: '00', date: 9, month: 4, year: 2023, allDay: false, name: 'SDA Individual workshop', type: 'coursework', location: 'Online' },
  { timeHour: '14', timeMinute: '00', date: 9, month: 4, year: 2023, allDay: false, name: 'SDA Individual workshop', type: 'coursework', location: 'Online' },
  { timeHour: '14', timeMinute: '00', date: 9, month: 4, year: 2023, allDay: false, name: 'SDA Individual workshop', type: 'coursework', location: 'Online' },
  { timeHour: '14', timeMinute: '00', date: 9, month: 4, year: 2023, allDay: false, name: 'SDA Individual workshop', type: 'coursework', location: 'Online' },
